...
use silica_cortexm3::ppb::scb::system_reset;
...
pub unsafe extern "C" fn start() -> ! {
    ...
    write_bytes(_bss_start, 0, _bss_size);
    ...
    copy(_idata_from, _idata_to, _idata_size);
...
pub unsafe extern "C" fn default_handler()  {
    ...
    let _ = isr_id; // to be used with our handler array
}
